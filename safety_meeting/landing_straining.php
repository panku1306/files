...
<hr>
<div id="frame" style="height: auto;min-height: 550px;padding-top: 15px;">
	<h3 style="text-align: center; margin-top: 0px; margin-bottom: 35px;">
		Employee Search <br> Safety Training
	</h3>
	...
	<div style="height:400px;overflow-y:auto;">
		<table class="table table-bordered table-striped table-condensed">
			...
			<tr class="<?=$c?>">
				<td width="350">
					<a href="/portal/weekly_tailgate/safety_training.php?emp=<?php echo $ob->id; ?>" >
